# generalized script for relay failure evaluation
import os
import gym
import procgen
import itertools
...
def main(args):
    ...
    if args.agent_type == 'ppo':
        ...
        raise ValueError('other agent algorithms not implemented')
    
    agent_pairs = list(itertools.combinations([i for i in range(1, args.num_agents + 1)], 2))
